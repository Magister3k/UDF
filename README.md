...
> `transcode_g723_ib_util` нельзя регистрировать под декларацией только с двумя
> параметрами: его ABI содержит четыре параметра. Для InterBase используйте
> `transcode_g723`, как в скрипте установки выше.
