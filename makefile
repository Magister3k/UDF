...
## test: Сборка автономной тестовой программы для проверки функции транскодирования
...
## clean: Очистка папки проекта от всех артефактов предыдущей компиляции и конечных файлов
clean:
	@echo ========================================================================
...
## info: Вывод текущих флагов компиляции в консоль
info:
